    ...
    register(api) {
        api.registerCli(({ program }) => {
            ...
            memok
                ...
                const cur = runtimeConfig.loadConfig();
        ...
        const hasUserCron = typeof userCron === "string" && userCron.trim().length > 0;
        const hasUserDailyAt = typeof entryConfig.dreamingPipelineDailyAt === "string" &&
        ...
        if ((pluginCfg.llmProvider ?? "inherit") !== "inherit" ||
